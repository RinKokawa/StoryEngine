...
- **故事编辑器**
  ...
  - **AI写作助手**：集成通义千问(Qwen)，提供智能写作建议和对话支持
- **卷章节管理**
  - 支持多卷多章节结构
  - 章节排序、状态管理
  - 章节内容独立存储与编辑
...
- **章节管理**
  ...
  - 支持章节重排序和状态管理
- **AI写作助手**
  - 点击编辑器右上角"AI助手"按钮打开对话面板
  - 首次使用需要设置Qwen API密钥（点击设置按钮⚙）
  - AI会根据当前项目和章节内容提供相关写作建议
  - 支持情节构思、角色设定、写作技巧等多种咨询
  - 详细使用说明请参考：[Qwen集成指南](docs/qwen-integration-guide.md)
- **仪表盘**
  - 显示总字数、目标进度、今日与本周字数
